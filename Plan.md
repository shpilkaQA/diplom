...
## Перечень используемых инструментов    
  ...
  * Docker Toolbox - программное решение для использования Docker на устаревшие системы Windows (Windows 7 в данном случае).  
...
1. Проблемы с Postgres на Windows 7.
